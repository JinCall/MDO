<template>
    <div class="">
    <router-link to="/proyectos/2004-2007" class="backContainer">
        ...
        <Slide v-for="(slide, index) in carouselSlide.img" :key="index">
            <div v-show="currentSlide === index + 2" class="slide__info img">
                <div class="slide__imgWrapper">
                    <img  class="slide__info__img" :src="require(`../../../assets/diapositivas/2004-2007/alameda/${slide.img}.jpg`)" alt="slide img">
                    <img  class="slide__info__img" :src="require(`../../../assets/diapositivas/2004-2007/alameda/${slide.img}.jpg`)" alt="slide img">
                </div>
            </div>
        </Slide>
...
export default {
    ...
    const carouselSlide = {
        logo: "logoMdo",
        presentation: {
        title: "PUERTA ALAMEDA",
        description: "Participación en el proyecto conceptual y ejecutivo, edificio habitacional y de comercios.",
