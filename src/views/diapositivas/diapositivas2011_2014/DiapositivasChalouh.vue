        ...
        <Slide v-for="(slide, index) in carouselSlide.img" :key="index">
            <div v-show="currentSlide === index + 2" class="slide__info img">
                <div class="slide__imgWrapper">
                    <img  class="slide__info__img" :src="require(`../../../assets/diapositivas/2011-2014/chalouh/${slide.img}.jpg`)" alt="slide img">
                    <img  class="slide__info__img" :src="require(`../../../assets/diapositivas/2011-2014/chalouh/${slide.img}.jpg`)" alt="slide img">
                </div>
            </div>
        </Slide>
...
export default {
    ...
    const carouselSlide = {
        ...
        presentation: {
        title: "CASA CHALOUH",
        description: "Desarrollo de proyecto conceptual, ejecutivo, renders y catálogo de presupuesto de ampliación y remodelación.",
