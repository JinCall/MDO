        ...
        <Slide v-for="(slide, index) in carouselSlide.img" :key="index">
            <div v-show="currentSlide === index + 2" class="slide__info img">
                <div class="slide__imgWrapper">
                    <img class="slide__info__img" :src="require(`../../../assets/diapositivas/2008-2011/alpha/${slide.img}.jpg`)" alt="slide img">
                    <img class="slide__info__img" :src="require(`../../../assets/diapositivas/2008-2011/alpha/${slide.img}.jpg`)" alt="slide img">
                </div>
            </div>
        </Slide>
...
export default {
    ...
    const carouselSlide = {
        logo: "logoMdo",
        presentation: {
        title: "CLUB DEPORTIVO ALPHA CHOLULA",
        description: "Participación en el desarrollo de Proyecto Arquitectónico.",
