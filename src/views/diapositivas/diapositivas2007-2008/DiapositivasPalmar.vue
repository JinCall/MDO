        ...
        <Slide v-for="(slide, index) in carouselSlide.img" :key="index">
            <div v-show="currentSlide === index + 2" class="slide__info img">
                <div class="slide__imgWrapper">
                    <img class="slide__info__img" :src="require(`../../../assets/diapositivas/2007-2008/palmar/${slide.img}.jpg`)" alt="slide img">
                    <img class="slide__info__img" :src="require(`../../../assets/diapositivas/2007-2008/palmar/${slide.img}.jpg`)" alt="slide img">
                </div>
            </div>
        </Slide>
...
export default {
    ...
    const carouselSlide = {
        logo: "logoMdo",
        presentation: {
        title: "EL PALMAR ACAPULCO",
        description: "Participación en el proyecto conceptual edificio habitacional.",
