<template>
    <div class="">
    <router-link to="/proyectos/concursos" class="backContainer">
        ...
        <Slide v-for="(slide, index) in carouselSlide.img" :key="index">
            <div v-show="currentSlide === index + 2" class="slide__info img">
                <div class="slide__imgWrapper">
                    <img   class="slide__info__img" :src="require(`../../../assets/diapositivas/concurso/umbral/${slide.img}.jpg`)" alt="slide img">
                    <img  class="slide__info__img" :src="require(`../../../assets/diapositivas/concurso/umbral/${slide.img}.jpg`)" alt="slide img">
                </div>
            </div>
        </Slide>
...
export default {
    ...
    const carouselSlide = {
        logo: "logoMdo",
        presentation: {
        title: "UMBRAL DE LAS AMÉRICAS",
        description: 'Objetivo: intervenir el puente peatonal "El Chaparral" en Tijuana.',
        date: "ORGANIZADO POR ARQUINE 2013-2014"
        },
        img: [
            {
            img: "1"
